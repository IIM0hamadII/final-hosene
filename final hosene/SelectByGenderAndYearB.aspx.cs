...
{
    public partial class SelectByGenderAndYearB : System.Web.UI.Page
    {
        public string st = "";
        public string msg = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sqlSelect += " where gender = 'male' and yearBorn BETWEEN '2005' AND '2008'";
